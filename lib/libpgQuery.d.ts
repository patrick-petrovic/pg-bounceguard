...
interface PLpgSQL_function {
  new_varno?: number
  old_varno?: number
  datums: Array<OneOfPLpgSQL_var | OneOfPLpgSQL_row | OneOfPLpgSQL_rec | OneOfPLpgSQL_recfield | OneOfPLpgSQL_arrayelem>
...
type PLpgSQL_variable = OneOfPLpgSQL_var | OneOfPLpgSQL_row | OneOfPLpgSQL_rec
...
interface NamedArgExpr {
  xpr?: OneOfNull
  arg: OneOfA_Const | OneOfTypeCast | OneOfColumnRef | OneOfA_Expr | OneOfFuncCall
  name: string
  argnumber: number
  location: number
}
...
interface SubLink {
  ...
  subLinkId?: number
  testexpr?: OneOfRowExpr | OneOfColumnRef | OneOfCaseExpr | OneOfTypeCast | OneOfA_Expr | OneOfA_Const
...
interface CoalesceExpr {
  ...
  args: Array<
    OneOfColumnRef | OneOfA_Const | OneOfA_Indirection | OneOfCaseExpr | OneOfTypeCast | OneOfA_Expr | OneOfFuncCall
  >
  location: number
}
...
interface MinMaxExpr {
  ...
  inputcollid?: number
  op: MinMaxOp
  args: Array<OneOfA_Const | OneOfColumnRef | OneOfFuncCall | OneOfA_Expr | OneOfMinMaxExpr | OneOfTypeCast>
  location: number
}
...
interface XmlExpr {
  ...
  args?: Array<
    OneOfFuncCall | OneOfXmlExpr | OneOfParamRef | OneOfColumnRef | OneOfA_Const | OneOfTypeCast | OneOfA_ArrayExpr
  >
...
interface NullTest {
  xpr?: OneOfNull
  arg: OneOfColumnRef | OneOfFuncCall | OneOfA_Indirection | OneOfA_Expr | OneOfTypeCast | OneOfRowExpr
...
interface BooleanTest {
  xpr?: OneOfNull
  arg: OneOfColumnRef | OneOfA_Expr | OneOfSubLink | OneOfFuncCall | OneOfTypeCast
...
interface JoinExpr {
  jointype: JoinType
  isNatural?: boolean
  larg: OneOfRangeVar | OneOfJoinExpr | OneOfRangeSubselect | OneOfRangeFunction
  rarg: OneOfRangeVar | OneOfJoinExpr | OneOfRangeSubselect | OneOfRangeFunction
...
interface DeleteStmt {
  ...
  whereClause?: OneOfA_Expr | OneOfBoolExpr | OneOfSubLink | OneOfNullTest | OneOfFuncCall | OneOfCurrentOfExpr
  returningList?: Array<OneOfResTarget>
  withClause?: WithClause
}
...
interface UpdateStmt {
  ...
  whereClause?:
    ...
    | OneOfCurrentOfExpr
    | OneOfSubLink
  fromClause?: Array<OneOfRangeVar | OneOfRangeSubselect | OneOfRangeFunction | OneOfJoinExpr>
  returningList?: Array<OneOfResTarget>
  withClause?: WithClause
}
...
interface SelectStmt {
  ...
  whereClause?:
    ...
    | OneOfBooleanTest
  groupClause?: Array<
    OneOfA_Expr | OneOfColumnRef | OneOfFuncCall | OneOfTypeCast | OneOfGroupingSet | OneOfRowExpr | OneOfA_Const
  >
...
interface AlterTableCmd {
  ...
  newowner?: RoleSpec
  def?:
    | OneOfList<OneOfDefElem<OneOfInteger | OneOfTypeName | OneOfString | OneOfFloat>>
    | OneOfPartitionCmd
    | OneOfRangeVar
    | OneOfA_Const
    | OneOfFuncCall
...
interface GrantStmt {
  ...
  objtype: ObjectType
  objects?: Array<OneOfString | OneOfRangeVar | OneOfList<OneOfString> | OneOfObjectWithArgs | OneOfInteger>
...
interface CopyStmt {
  relation?: RangeVar
  query?: OneOfInsertStmt | OneOfUpdateStmt | OneOfDeleteStmt | OneOfSelectStmt
  attlist?: Array<OneOfString>
  is_from?: boolean
  is_program?: boolean
  filename?: string
  options?: Array<OneOfDefElem<OneOfString | OneOfInteger | OneOfA_Star | OneOfList<OneOfString>>>
...
interface CreateStmt {
  ...
  options?: Array<OneOfDefElem<OneOfInteger | OneOfTypeName | OneOfString | OneOfFloat>>
  oncommit: OnCommitAction
  tablespacename?: string
  accessMethod?: string
...
interface DefineStmt {
  ...
  args?: Array<OneOfInteger | OneOfList<OneOfFunctionParameter> | EmptyObject>
  definition?: Array<OneOfDefElem<OneOfTypeName | OneOfString | OneOfInteger | OneOfList<OneOfString>>>
  if_not_exists?: boolean
  replace?: boolean
}

interface DropStmt {
  objects: Array<OneOfString | OneOfList<OneOfString | OneOfTypeName> | OneOfObjectWithArgs | OneOfTypeName>
...
interface CommentStmt {
  objtype: ObjectType
  object: OneOfList<OneOfString | OneOfTypeName> | OneOfString | OneOfObjectWithArgs | OneOfTypeName
  comment?: string
}
...
interface CreateFunctionStmt {
  ...
  returnType?: TypeName
  options: Array<OneOfDefElem<OneOfList<OneOfString> | OneOfString | OneOfFloat | OneOfInteger | OneOfVariableSetStmt>>
}

interface AlterFunctionStmt {
  objtype: ObjectType
  func: ObjectWithArgs
  actions: Array<OneOfDefElem<OneOfInteger | OneOfString | OneOfVariableSetStmt | OneOfList<OneOfString>>>
}
...
interface RuleStmt {
  ...
  event: CmdType
  instead?: boolean
  actions?: Array<OneOfInsertStmt | OneOfString | OneOfDeleteStmt | OneOfUpdateStmt | OneOfNotifyStmt | OneOfSelectStmt>
  replace?: boolean
}
...
interface CreateSeqStmt {
  sequence: RangeVar
  options?: Array<OneOfDefElem<OneOfInteger | OneOfTypeName | OneOfList<OneOfString>>>
  ownerId?: number
...
interface AlterSeqStmt {
  sequence: RangeVar
  options: Array<OneOfDefElem<OneOfTypeName | OneOfInteger | OneOfList<OneOfString>>>
  for_identity?: boolean
  missing_ok?: boolean
}
...
interface CreateRoleStmt {
  ...
  role: string
  options?: Array<OneOfDefElem<OneOfList<OneOfRoleSpec> | OneOfInteger | OneOfString>>
}

interface AlterRoleStmt {
  role: RoleSpec
  options: Array<OneOfDefElem<OneOfInteger | OneOfString | OneOfList<OneOfRoleSpec>>>
  action: number
}
...
interface PrepareStmt {
  ...
  query: OneOfSelectStmt | OneOfExecuteStmt | OneOfInsertStmt | OneOfUpdateStmt
}

interface ExecuteStmt {
  name: string
  params?: Array<OneOfA_Const | OneOfTypeCast | OneOfFuncCall | OneOfA_ArrayExpr>
}
...
interface CreatePolicyStmt {
  ...
  permissive?: boolean
  roles: Array<OneOfRoleSpec>
  qual?: OneOfA_Expr | OneOfTypeCast | OneOfFuncCall | OneOfBoolExpr | OneOfCaseWhen | OneOfSubLink | OneOfCaseExpr
...
interface CollateClause {
  arg?: OneOfColumnRef | OneOfTypeCast | OneOfA_Const | OneOfA_ArrayExpr | OneOfCaseExpr | OneOfA_Expr
  collname: Array<OneOfString>
  location: number
}
...
interface ColumnDef {
  ...
  storage?: string
  raw_default?: OneOfTypeCast | OneOfFuncCall | OneOfA_Expr | OneOfCaseExpr | OneOfA_Const
...
interface IndexElem {
  name?: string
  expr?: OneOfA_Expr | OneOfFuncCall | OneOfCollateClause | OneOfA_Const | OneOfRowExpr | OneOfCoalesceExpr
  indexcolname?: string
...
interface GroupingSet {
  ...
  content?: Array<OneOfColumnRef | OneOfGroupingSet | OneOfRowExpr | OneOfA_Expr | OneOfTypeCast | OneOfA_Const>
  location: number
}
...
interface CommonTableExpr {
  ...
  ctequery?: OneOfSelectStmt | OneOfInsertStmt | OneOfUpdateStmt | OneOfDeleteStmt
  location: number
...
interface PartitionElem {
  name?: string
  expr?: OneOfA_Expr | OneOfFuncCall | OneOfA_Const | OneOfRowExpr | OneOfTypeCast | OneOfColumnRef
  collation?: Array<OneOfString>
  opclass?: Array<OneOfString>
  location: number
}
...
interface PartitionBoundSpec {
  ...
  remainder?: number
  listdatums?: Array<
    OneOfA_Const | OneOfTypeCast | OneOfA_Expr | OneOfColumnRef | OneOfFuncCall | OneOfSubLink | OneOfCollateClause
  >
  lowerdatums?: Array<
    | OneOfA_Const
    | OneOfColumnRef
